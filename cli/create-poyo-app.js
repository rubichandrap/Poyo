...
const BINARY_EXTENSIONS = [
    '.dll', '.exe', '.png', '.jpg', '.jpeg', '.gif', '.ico', '.webp', '.pdf', '.woff', '.woff2', '.ttf', '.eot'
];
...
async function create(options) {
    ...
    if (!projectName) {
        projectName = await input({ message: 'Project Name:', default: 'MyPoyoApp' });
    }
...
program
    ...
    .option('--project <name>', 'Name of the project (deprecated, use argument instead)')
